...
func ExampleSortByIncreasingPrice() {
	incresingPrice := sortByIncreasingPrice(houses)
	fmt.Println(incresingPrice)
	//Output:[{2 3-х ком. квартира возле рынка Саховат 80 200 Фирдавси} {1 2-х ком квартира в центре города 100 100 Рудаки} {3 Земельный участок 20 соток 500 300 Сино} {4 Пентхаус в центре города 500 50 Исмоили Сомони}]
	}
func ExampleSortByDecreasingPrice(){
	decreasingPrice := sortByDecreasingPrice(houses)
	fmt.Println(decreasingPrice)
	//Output:[{3 Земельный участок 20 соток 500 300 Сино} {4 Пентхаус в центре города 500 50 Исмоили Сомони} {1 2-х ком квартира в центре города 100 100 Рудаки} {2 3-х ком. квартира возле рынка Саховат 80 200 Фирдавси}]
	}
func ExampleSortByNearestFromCenter()  {
	nearFromCenter:=sortByNearestFromCenter(houses)
	fmt.Println(nearFromCenter)
	//Output:[{4 Пентхаус в центре города 500 50 Исмоили Сомони} {1 2-х ком квартира в центре города 100 100 Рудаки} {2 3-х ком. квартира возле рынка Саховат 80 200 Фирдавси} {3 Земельный участок 20 соток 500 300 Сино}]
	}
func ExampleSortByFurthestFromCenter()  {
	farFromCenter:= sortByFurthestFromCenter(houses)
	fmt.Println(farFromCenter)
	//Output:[{3 Земельный участок 20 соток 500 300 Сино} {2 3-х ком. квартира возле рынка Саховат 80 200 Фирдавси} {1 2-х ком квартира в центре города 100 100 Рудаки} {4 Пентхаус в центре города 500 50 Исмоили Сомони}]
	}
...
func ExampleSearchByMaxPrice_TwoOrMoreResults()  {
	...
	fmt.Println(result)
	//Output:[{1 2-х ком квартира в центре города 100 100 Рудаки} {2 3-х ком. квартира возле рынка Саховат 80 200 Фирдавси} {3 Земельный участок 20 соток 500 300 Сино} {4 Пентхаус в центре города 500 50 Исмоили Сомони}]
	}
...
func ExampleSearchByMaxAndMinPrice()  {
	...
	fmt.Println(result)
	//Output:[{1 2-х ком квартира в центре города 100 100 Рудаки} {2 3-х ком. квартира возле рынка Саховат 80 200 Фирдавси}]
}
...
func ExampleSearchByRegions()  {
	...
	fmt.Println(result)
	//Output:[{1 2-х ком квартира в центре города 100 100 Рудаки} {2 3-х ком. квартира возле рынка Саховат 80 200 Фирдавси} {4 Пентхаус в центре города 500 50 Исмоили Сомони}]
	}
